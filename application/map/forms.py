...
class NewMapForm(FlaskForm):
	...
	width = IntegerField("Map width", [validators.DataRequired(), validators.NumberRange(1, 20)])
	height = IntegerField("Map height", [validators.DataRequired(), validators.NumberRange(1, 20)])
